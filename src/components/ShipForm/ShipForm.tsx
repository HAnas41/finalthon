...
import ShippingLabelInp from '../ShipLabelInput/ShipLabelInput';
import ShippingInput from '../ShipInput/ShipInput';
...
function ShipppingForm() {
    const {shipmentInp,onHandleShipmentForm,loading} = useWearHook()
    return(
