...
import CartCard from "../CartCrd/CartCrd";
import CartOtherDetail from "../CartDetailtwo/CartDetailtwo";
...
function CartDetail() {
  ...
  if(addCartProd.length>0){
    ...
    return(
      ...
      <h2 className={`${poppins.className} text-4xl`}>No Product in Cart</h2>
      </section>
    )
  }
}
